...
},
{
  ...
  type: "domain-registrar",
  name: "NordName",
  description: "NordName registrar extension for FOSSBilling",
  author: getAuthor("c-softoy"),
  license: {
    name: "MIT license",
    URL: "https://github.com/c-softoy/nordname-fossbilling-module/blob/main/LICENSE",
  },
  source: {
    type: "github",
    repo: "c-softoy/nordname-fossbilling-module",
  },
  version: "1.0.0",
  download_url:
    "https://github.com/c-softoy/nordname-fossbilling-module",
  releases: [
    {
      tag: "1.0.0",
      date: "2026-06-19T16:42:00Z",
      download_url:
        "https://github.com/c-softoy/nordname-fossbilling-module",
      changelog_url:
        "https://github.com/c-softoy/nordname-fossbilling-module/commits/main/",
      min_fossbilling_version: "0.8.2",
    },
  ],
  icon_url:
    "https://avatars.githubusercontent.com/u/7603033",
  website: "https://nordname.com",
  readme: `# NordName FOSSBilling Registrar Module
...
|---------|----------|-------------|
| **API Key** | Yes | Your NordName reseller API key. |
| **Admin/tech/billing contact ID** | Yes | Contact ID of an existing NordName contact with is_registrant = false. Used as admin, tech, and billing contact on all registrations and transfers. |
| **Sandbox mode** | No | No (production), Yes for OTE. Test in OTE before going live. |
...
| **Renewal date offset (days)** | No | When set, the cron job sets each synced order's renewal date to the domain expiration date minus this many days. Leave empty to leave order renewal dates unchanged.|
...
- **Invalid API key** — the module could not access the NordName API.
- **Invalid auxiliary contact ID** — The contact does not exist.
...
2. Syncs nameservers (ns1–ns4) on the domain service from the registrar data returned by WHOIS sync
...
The extension module provides an admin tool at **Extensions → NordName registrar** for importing or updating TLD pricing from NordName.
...
2. Click **Load TLDs** to fetch the catalog and wholesale prices from NordName
...
- Registration and renewal sell prices are based on NordName wholesale price (EUR) × minimum registration years
...
- NordName API v3 specification: [OpenAPI 3.0](https://app.nordname.eu/en/api-docs)
