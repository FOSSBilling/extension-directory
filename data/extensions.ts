...
1. FOSSBilling for their open-source billing platform.`,
}
  {
    ...
    type: "payment-gateway",
    name: "Amazon Pay",
    description: "Amazon Pay payment gateway for FOSSBilling",
    author: findAuthorByID("axynuk"),
    license: {
      name: "Apache 2.0",
      URL: "https://www.apache.org/licenses/LICENSE-2.0",
    },
    ...
    version: "1.0.0",
    download_url:
      "https://github.com/AXYNUK/fossbilling-amazonpay/archive/refs/heads/main.zip",
    releases: [
      {
        tag: "1.0.0",
        ...
        download_url:
          "https://github.com/AXYNUK/fossbilling-amazonpay/archive/refs/heads/main.zip",
        changelog_url:
          "https://github.com/AXYNUK/fossbilling-amazonpay/blob/main/README.md",
        min_fossbilling_version: "0.6",
      },
    ],
    icon_url:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Amazon-Pay-Logo.svg/200px-Amazon-Pay-Logo.svg.png",
    website: "https://axyn.co.uk",
    readme: \`# Amazon Pay Payment Gateway for FOSSBilling

This extension integrates Amazon Pay as a payment gateway for FOSSBilling, supporting both one-time and recurring payments.

## Features
- ✅ One-time and recurring payments
- ✅ Full transaction processing with error handling  
- ✅ Comprehensive logging for debugging
- ✅ Sandbox and production support
- ✅ Secure authentication using Amazon Pay API v2
- ✅ Configuration validation
- ✅ Proper FOSSBilling integration
