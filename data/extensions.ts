...
},
{
  ...
  version: "1.0.0",
  download_url:
    "https://github.com/AXYNUK/2fa-fossbilling/releases/download/v1.0.0/Twofactorauth-1.0.0.zip",
  releases: [
    {
      tag: "1.0.0",
...
1. Download \`Twofactorauth-1.0.0.zip\` from the [latest release](https://github.com/AXYNUK/2fa-fossbilling/releases)
2. Extract to your FOSSBilling installation root (preserves \`modules/Twofactorauth/\` structure)
3. Go to **Extensions → Extensions** in admin panel
4. Find "Two-Factor Authentication" and activate it
